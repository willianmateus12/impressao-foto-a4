...
9. **Várias fotos (colagem automática)** — no modo "Caber na folha", as fotos são montadas em **colagem estilo editor** preenchendo a folha (ex.: 4 fotos = uma grande + 3 ao lado; 2 = lado a lado; etc.), cada uma encaixada inteira na sua célula, sem cortar nem distorcer. O botão "▦ Organizar em colagem" refaz o arranjo a qualquer momento. Ao mover/redimensionar, a foto sai da colagem e passa a ser livre.
